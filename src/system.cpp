...
static void product_info_update(void)
{
    ...
    length = set_wifi_uart_buffer(length, reinterpret_cast<const unsigned char*>("{\"p\":\""), my_strlen((unsigned char*)"{\"p\":\""));
    length = set_wifi_uart_buffer(length,(const unsigned char *)PRODUCT_KEY,my_strlen((unsigned char *)PRODUCT_KEY));
    length = set_wifi_uart_buffer(length, reinterpret_cast<const unsigned char*>("\",\"v\":\""), my_strlen((unsigned char*)"\",\"v\":\""));
    length = set_wifi_uart_buffer(length,(const unsigned char *)MCU_VER,my_strlen((unsigned char *)MCU_VER));
    length = set_wifi_uart_buffer(length, reinterpret_cast<const unsigned char*>("\",\"m\":"), my_strlen((unsigned char*)"\",\"m\":"));
    length = set_wifi_uart_buffer(length, (const unsigned char *)CONFIG_MODE, my_strlen((unsigned char *)CONFIG_MODE));
